@extends('layouts.app')
@section('title', config('app.name') . ' | نموذج طلب خدمة')
    ...
    <div class="w3-content w3-container w3-section">
        <form action="" method="get">
            ...
            <div id="details-animals" class="section hide">
                ...
                <p>
                    <input class="animalsEmphasisConditions" name="animalsEmphasisConditions" id="animalsEmphasisConditions"
                        type="radio">
                    <label for="animalsEmphasisConditions">لقد قمت بقراءة <a href="javascript:void(0)"
                            onclick="document.getElementById('id01').style.display='block'"
                            id="animalsEmphasisConditions-modal" class="i-not-btn bold cnsb-txt-red i"> الشروط</a> وأنا موافق
                        عليها
                    </label>
                </p>
            ...
            <div id="details-planting" class="section hide">
                ...
                <p>
                    <input class="plantingEmphasisConditions" name="plantingEmphasisConditions"
                        id="plantingEmphasisConditions" type="radio">
                    <label for="plantingEmphasisConditions">لقد قمت بقراءة <a href="javascript:void(0)"
                            onclick="document.getElementById('id01').style.display='block'"
                            id="plantingEmphasisConditions-modal" class="i-not-btn"> الشروط</a> وأنا موافق عليها
                    </label>
                </p>
                <div class="w3-row-padding w3-stretch">
                    <p class="w3-col l5 w3-right">
                        <label for="plantingWeight">ماهو وزن منقولاتك ؟</label>
                        <input class="plantingWeight" name="plantingWeight" id="plantingWeight" type="number"
                            placeholder="أكتب وزن تقديري لمنقولاتك">
                    </p>
                    <p class="w3-col l2 w3-right">
                        <label for="plantingWeightUnit">وحدة الوزن</label>
                        <select style="padding-top: .6pc;" class="plantingWeightUnit special-selection"
                            name="plantingWeightUnit" id="plantingWeightUnit">
            ...
            <div id="details-merchandise" class="section hide">
                ...
                <p>
                    <input class="merchandiseEmphasisConditions" name="merchandiseEmphasisConditions"
                        id="merchandiseEmphasisConditions" type="radio">
                    <label for="merchandiseEmphasisConditions">لقد قمت بقراءة <a href="javascript:void(0)"
                            onclick="document.getElementById('id01').style.display='block'"
                            id="merchandiseEmphasisConditions-modal" class="i-not-btn"> الشروط</a> وأنا موافق
                        عليها
                    </label>
                </p>
                <div class="w3-row-padding w3-stretch">
                    <p class="w3-col l5 w3-right">
                        ...
                        <input class="merchandiseWeight" name="merchandiseWeight" id="merchandiseWeight" type="number"
                            placeholder="أكتب  تقديري لمنقولاتك">
                    </p>
                    <p class="w3-col l2 w3-right">
                        <label for="merchandiseWeightUnit">وحدة الوزن</label>
                        <select class="merchandiseWeightUnit special-selection" name="merchandiseWeightUnit"
                            id="merchandiseWeightUnit">
                            <option value="">كيلو جرام</option>
                            <option value="">طن</option>
                        </select>
                    </p>
                    ...
                    <p class="w3-col l5">
                        ...
                        <select class="merchandiseVehicle special-selection" name="merchandiseVehicle"
                            id="merchandiseVehicle">
                            <option value="1">شاحنة نقل كبيرة جدا</option>
                            <option value="2">شاحنة نقل كبيرة</option>
                            <option value="3">شاحنة نقل صغيرة</option>
                            <option value="4">دباب</option>
            ...
            <div id="details-dismantling-workers" class="section hide">
                ...
                <p>
                    ...
                    <input class="dismantlingWorkersAdTitle" name="dismantlingWorkersAdTitle"
                        id="dismantlingWorkersAdTitle">
                </p>
                <p>
                    <input class="dismantlingWorkersEmphasisConditions" name="dismantlingWorkersEmphasisConditions"
                        id="dismantlingWorkersEmphasisConditions" type="radio">
                    <label for="dismantlingWorkersEmphasisConditions">لقد قمت بقراءة <a href="javascript:void(0)"
                            onclick="document.getElementById('id01').style.display='block'"
                            id="dismantlingWorkersEmphasisConditions-modal" class="i-not-btn"> الشروط</a> وأنا
                        موافق عليها
                    </label>
                </p>
                <div class="w3-row-padding w3-stretch">
                    ...
                    <select class="dismantlingWorkersContents" name="dismantlingWorkersContents"
                        id="dismantlingWorkersContents">
                ...
                <p>
                    ...
                    <textarea class="dismantlingWorkersDescription" name="dismantlingWorkersDescription" id="dismantlingWorkersDescription"
                        rows="5"></textarea>
                </p>
                <p>
                    <label for="dismantlingWorkersFiles">قم بإضافة صور لإعلانك (اختياري)</label>
                    <input class="dismantlingWorkersFiles" name="dismantlingWorkersFiles" id="dismantlingWorkersFiles"
                        type="file">
                </p>
            ...
            <div id="details-upload-download-workers" class="section hide">
                ...
                <p>
                    ...
                    <input class="uploadDownloadWorkersAdTitle" name="uploadDownloadWorkersAdTitle"
                        id="uploadDownloadWorkersAdTitle">
                </p>
                <p>
                    <input class="uploadDownloadWorkersEmphasisConditions" name="uploadDownloadWorkersEmphasisConditions"
                        id="uploadDownloadWorkersEmphasisConditions" type="radio">
                    <label for="uploadDownloadWorkersEmphasisConditions">لقد قمت بقراءة <a href="javascript:void(0)"
                            onclick="document.getElementById('id01').style.display='block'"
                            id="uploadDownloadWorkersEmphasisConditions-modal" class="i-not-btn"> الشروط</a>
                        وأنا
                        موافق عليها
                    </label>
                </p>
                <div class="w3-row-padding w3-stretch">
                    ...
                    <select class="uploadDownloadWorkersContents" name="uploadDownloadWorkersContents"
                        id="uploadDownloadWorkersContents">
                        <option value="1">غرفة</option>
                        <option value="2">عدد من الغرف</option>
                        <option value="3">شقة من غرفتين</option>
                        <option value="4">شقة من 3-5 غرف</option>
                ...
                <p>
                    ...
                    <textarea class="uploadDownloadWorkersDescription" name="uploadDownloadWorkersDescription"
                        id="uploadDownloadWorkersDescription" rows="5"></textarea>
                </p>
                <p>
                    <label for="uploadDownloadWorkersFiles">قم بإضافة صور لإعلانك (اختياري)</label>
                    <input class="uploadDownloadWorkersFiles" name="uploadDownloadWorkersFiles"
                        id="uploadDownloadWorkersFiles" type="file">
                </p>
                <a class="steps-button steps-button-location" href="javascript:void(0)">التالي</a>
                ...
                <div class="w3-modal-content">
                    ...
                    <div class="w3-container">
                        <span onclick="document.getElementById('id01').style.display='none'"
                            class="w3-display-topleft w3-bar-item w3-grey w3-large w3-button">&times;</span>
            ...
            <div id="pay-and-post" class="section hide">
                ...
                <ul class="w3-ul">
                    <li><a href="javascript:void(0)" onclick="document.getElementById('id02').style.display='block'"
                            class="i-not-btn bold i cnsb-txt-red">لماذا أقوم بالدفع قبل النشر</a></li>
                </ul>
                <p style="padding-bottom: 0!important;">
                    <label for="paymentMail">معالجة المدفوعات</label>
                    <input class="paymentMail i-not-btn w3-text-black w3-left-align" name="paymentMail" id="paymentMail"
                        type="email" value="moatazads.795@gmail.com" disabled>
                </p>
